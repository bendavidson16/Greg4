...
game.setLocalization("tc.research_name.IT_ICHOR", "Ichor");
game.setLocalization("tc.research_text.IT_ICHOR", "[TTkami] Blood of the Gods");
...
game.setLocalization("tc.research_name.IT_ICHORIUM", "Ichorium");
game.setLocalization("tc.research_text.IT_ICHORIUM", "[TTkami] Not from the 55th floor");
...
game.setLocalization("tc.research_text.CAP_ICHOR", "[TTkami] Somewhat like a Steam Sale");
Research.addPage("CAP_ICHOR", "ttresearch.page.CAP_ICHOR.0");
game.setLocalization("infitech.research_page.CAP_ICHOR.1", "You have put Ichorium to its first ever use, by devising wand caps that give you a 30% discount on everything. Now you need to actually put this to any use and create a wand that can store more vis.");
...
game.setLocalization("tc.research_name.IT_ICHOR_TOOLS", "Ichorium Tools");
game.setLocalization("tc.research_text.IT_ICHOR_TOOLS", "[TTkami] The top tier of rat... tools");
